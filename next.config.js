...
const nextConfig = {
  ...
  env: {
    NEXT_PUBLIC_GA_MEASUREMENT_ID: "G-41ZW7BWZXY" || process.env.NEXT_PUBLIC_GA_MEASUREMENT_ID,
    NEXT_PUBLIC_IMAGE_NAME: "images/DSC00355" || process.env.NEXT_PUBLIC_IMAGE_NAME,
